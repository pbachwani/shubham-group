  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className=" absolute top-0 right-0 w-full flex items-end justify-end p-[2em] bg-transparent pointer-events-none z-20"
        ...
        >
          ...
          >
            <span
              ref={textWrapRef}
              className="sm-toggle-textWrap relative inline-block h-[1em] overflow-hidden whitespace-nowrap w-[var(--sm-toggle-width,auto)] min-w-[var(--sm-toggle-width,auto)] text-accent"
              aria-hidden="true"
            >
              <span
                ref={textInnerRef}
